...
![image](https://hackmd.io/_uploads/H1s4fSjxbg.png)\
![image](https://hackmd.io/_uploads/BJVKiBsl-x.png)
...
Additionally, you have to handle the `venumentrada.txt` and get the PowerShell loader script that decoded the `runpe.txt`, renamed `swchost.exe` and execute immediately.![image](https://hackmd.io/_uploads/ryjWE8slWl.png)
...
![image](https://hackmd.io/_uploads/HJFcPLjlbe.png)
...
![image](https://hackmd.io/_uploads/Hy8ktIjlZx.png)

## Persistence 

Following the Sysmon logs, I realized that the malware copy itself to another location.
![image](https://hackmd.io/_uploads/ByxSgPsxbg.png)
...
![image](https://hackmd.io/_uploads/SJ3VNvsl-x.png)
...
![image](https://hackmd.io/_uploads/HkyM8vogbg.png)
